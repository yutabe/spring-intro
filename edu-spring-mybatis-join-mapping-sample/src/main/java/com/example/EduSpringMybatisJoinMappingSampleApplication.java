...
public class EduSpringMybatisJoinMappingSampleApplication {

    public static void main(String[] args) {
        ApplicationContext context = SpringApplication.run(EduSpringMybatisJoinMappingSampleApplication.class, args);
